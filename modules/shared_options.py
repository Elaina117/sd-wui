...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "CLIP_stop_at_last_layers": OptionInfo(1, "Clip skip", gr.Slider, {"minimum": 1, "maximum": 12, "step": 1}, infotext="Clip skip").link("wiki", "https://github.com/AUTOMATIC1111/stable-diffusion-wui/wiki/Features#clip-skip").info("ignore last layers of CLIP network; 1 ignores none, 2 ignores one layer"),
...
options_templates.update(options_section(('optimizations', "Optimizations"), {
    ...
    "s_min_uncond": OptionInfo(0.0, "Negative Guidance minimum sigma", gr.Slider, {"minimum": 0.0, "maximum": 15.0, "step": 0.01}).link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-wui/pull/9177").info("skip negative prompt for some steps when the image is almost ready; 0=disable, higher=faster"),
...
options_templates.update(options_section(('sampler-params', "Sampler parameters"), {
    ...
    'sgm_noise_multiplier': OptionInfo(False, "SGM noise multiplier", infotext='SGM noise multplier').link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-wui/pull/12818").info("Match initial noise to official SDXL implementation - only useful for reproducing images"),

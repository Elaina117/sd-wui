...
options_templates.update(options_section(('saving-to-dirs', "Saving to a directory"), {
    ...
    "directories_filename_pattern": OptionInfo("[date]", "Directory name pattern", component_args=hide_dirs).link("wiki", ""),
...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "CLIP_stop_at_last_layers": OptionInfo(1, "Clip skip", gr.Slider, {"minimum": 1, "maximum": 12, "step": 1}, infotext="Clip skip").link("wiki", "").info("ignore last layers of CLIP network; 1 ignores none, 2 ignores one layer"),
...
options_templates.update(options_section(('optimizations', "Optimizations"), {
    ...
    "s_min_uncond": OptionInfo(0.0, "Negative Guidance minimum sigma", gr.Slider, {"minimum": 0.0, "maximum": 15.0, "step": 0.01}).link("PR", "").info("skip negative prompt for some steps when the image is almost ready; 0=disable, higher=faster"),
    "token_merging_ratio": OptionInfo(0.0, "Token merging ratio", gr.Slider, {"minimum": 0.0, "maximum": 0.9, "step": 0.1}, infotext='Token merging ratio').link("PR", "").info("0=disable, higher=faster"),
...
options_templates.update(options_section(('sampler-params', "Sampler parameters"), {
    ...
    'always_discard_next_to_last_sigma': OptionInfo(False, "Always discard next-to-last sigma", infotext='Discard penultimate sigma').link("PR", ""),
    'sgm_noise_multiplier': OptionInfo(False, "SGM noise multiplier", infotext='SGM noise multplier').link("PR", "").info("Match initial noise to official SDXL implementation - only useful for reproducing images"),

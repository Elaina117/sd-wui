...
def create_ui():
    ...
    with gr.Blocks(analytics_enabled=False) as train_interface:
        with gr.Row(equal_height=False):
            gr.HTML(value="<p style='margin-bottom: 0.7em'>See <b><a href=\"https://github.com/AUTOMATIC1111/stable-diffusion-wui/wiki/Textual-Inversion\">wiki</a></b> for detailed explanation.</p>")
        ...
        with gr.Row(variant="compact", equal_height=False):
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train", id="train"):
                    gr.HTML(value="<p style='margin-bottom: 0.7em'>Train an embedding or Hypernetwork; you must specify a directory with a set of 1:1 ratio images <a href=\"https://github.com/AUTOMATIC1111/stable-diffusion-wui/wiki/Textual-Inversion\" style=\"font-weight:bold;\">[wiki]</a></p>")
                    with FormRow():
...
def versions_html():
    ...
    return f"""
version: <a href="https://github.com/AUTOMATIC1111/stable-diffusion-wui/commit/{commit}">{tag}</a>
&#x2000;•&#x2000;
